		...
		return {
			...
			addSVG: function (src, x, y, renderSVG) {
				...
				fabric.Image.fromURL(src, function (oImg) {
					...
					y = y || 0;
					y = formatY(y);
					console.log("B scale:"+obj);
					obj.scale(constConvert / mm2px);
					console.log("Rate: "+ constConvert / mm2px);
					console.log("A scale:"+obj);
			...
			addImage: function (src, x, y, sendQueue) {
				...
				src = str_replace('//upload', '/upload', src);
				console.log("src cuoi" + src);
				src ='http://'+src;
				fabric.Image.fromURL(src, function (oImg) {
					console.log("src fa: "+ src);
					obj = oImg;
					x = x || 0;
					y = y || 0;
					//console.log(x +' ' + y);
