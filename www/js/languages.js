angular.module('defmApp.languages', [])
	...
	$translateProvider.translations('vi', 
		{
			...
			"SOCKET_DISCONNECTED_MESSAGE"		: "Không thể kết nối server, hãy kiểm tra lại đường truyền và HOST ở mục Thiết đặt.",
	...
	$translateProvider.translations('en-US', 
		{
			...
			"SOCKET_DISCONNECTED_MESSAGE"		: "We have just disconnected from the the defmApp, please check your connection and the Host Address in Settings tab.",
